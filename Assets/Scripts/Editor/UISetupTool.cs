...
public static class UISetupTool
{
    ...
    static void SetupLevelConfirmPanel()
    {
        ...
        // Level name text (filled at runtime by UIManager)
        GameObject nameObj = CreateLabel(panel, "Level Name", 30);
        nameObj.name = "LevelTextName";

        // Wire Start and Back buttons to UIManager
        ...
        // Assign the label to UIManager's confirmLevelNameText field
        if (uiManager != null)
    ...
    static UIManager FindUIManager()
    {
